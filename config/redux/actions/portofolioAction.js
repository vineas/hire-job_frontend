...
export const getPortofolio = (setPortofolio) => async (dispatch) => {
  try {
    axios
      .get(`http://hire-job-backend-14io6stvb-alvienasyandika-gmailcom.vercel.app/portofolio`)
...
export const getDetailPortofolio = (setPortofolio, id) => async (dispatch) => {
  try {
    axios.get(`http://hire-job-backend-14io6stvb-alvienasyandika-gmailcom.vercel.app/portofolio/${id}`).then((res) => {
...
export const createPortofolio = (portofolio, portofolio_image) => async (dispatch) => {
  try {
    ...
    axios.post(`http://hire-job-backend-14io6stvb-alvienasyandika-gmailcom.vercel.app/portofolio`, formData)
      .then((res) => {
        console.log(res);
        Swal.fire({
